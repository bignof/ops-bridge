...
from app.hub.models import CommandEventSnapshot, CommandListResponse, CommandSnapshot
...
def _require_admin_token(admin_token: str | None) -> None:
    ...
    if not _hub_settings.admin_token:
    ...
    if not admin_token or not hmac.compare_digest(admin_token, _hub_settings.admin_token):
